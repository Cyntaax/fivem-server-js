...
declare type FaceFeaturesSettingsKey = keyof PedFaceFeatures;
declare type FaceFeaturesSettingsValue = {
    min: number;
    max: number;
    factor: number;
};
export declare type FaceFeaturesSettings = Record<FaceFeaturesSettingsKey, FaceFeaturesSettingsValue>;
declare type HeadOverlaysSettingsKey = keyof PedHeadOverlays;
declare type HeadOverlaysSettingsValue = {
    style: {
        min: number;
        max: number;
    };
...
export declare type HeadOverlaysSettings = Record<HeadOverlaysSettingsKey, HeadOverlaysSettingsValue>;
