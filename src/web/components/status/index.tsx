...
const Status: FC = observer(() => {
	...
	events.addHandler<{ health: number; energy: number; stamina: number }>("hud:status", (data) => {
		console.log(`circles`, JSON.stringify(_circles));
		Object.keys(data).forEach((v) => {
			updateCircle(v, data[v as keyof typeof data]);
		});
	});
